...
1. [This Document](https://github.com/WIAG-ADW-GOE/sync_notebooks/Readme.md)
2. [Software Installation](https://github.com/WIAG-ADW-GOE/sync_notebooks/docs/Installation.md)
3. [Running SQL](https://github.com/WIAG-ADW-GOE/sync_notebooks/docs/Run_SQL_Query_and_Export_CSV.md)
4. [Running Factgrid](https://github.com/WIAG-ADW-GOE/sync_notebooks/docs/Run_factgrid_csv.md)
5. [Exporting Personen and Amstdaten from WIAG](https://github.com/WIAG-ADW-GOE/sync_notebooks/docs/wiag_export.md)

The recommended way is to first install the software as described in the [Software Installation](https://github.com/WIAG-ADW-GOE/sync_notebooks/docs/Installation.md) guide and then download [this repository as a zip file](https://github.com/WIAG-ADW-GOE/WIAGweb2/archive/refs/heads/main.zip) and running the notebooks. More details are provided below.

## Prerequisites

### Software Requirements

The installation of the software mentioned below is mentioned [in detail here](https://github.com/WIAG-ADW-GOE/sync_notebooks/docs/Installation.md).
...
**Notebook**: [pr_recon.ipynb](https://github.com/WIAG-ADW-GOE/sync_notebooks/pr_recon.ipynb)
...
**Notebook**: [factgrid_recon.ipynb](https://github.com/WIAG-ADW-GOE/sync_notebooks/factgrid_recon.ipynb)
...
**Notebook**: [FactGrid-IDs2WIAG.ipynb](https://github.com/WIAG-ADW-GOE/sync_notebooks/FactGrid-IDs2WIAG.ipynb)
...
**Notebook**: [Csv2FactGrid-create.ipynb](https://github.com/WIAG-ADW-GOE/sync_notebooks/Csv2FactGrid-create.ipynb)
...
**Notebook**: [wiag_to_factgrid.ipynb](https://github.com/WIAG-ADW-GOE/sync_notebooks/wiag_to_factgrid.ipynb)
...
**Notebook**: [fg_to_pr.ipynb](https://github.com/WIAG-ADW-GOE/sync_notebooks/fg_to_pr.ipynb)
...
**Notebook**: [pr_to_fg.ipynb](https://github.com/WIAG-ADW-GOE/sync_notebooks/pr_to_fg.ipynb)
